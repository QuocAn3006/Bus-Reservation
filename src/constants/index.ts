export const provincesApi = process.env.NEXT_PUBLIC_API_PROVINCES as string;
...
export const imageNews = [
	{
		name: 'PHƯƠNG TRANG - FUTA BUS LINES TƯNG BỪNG KHAI TRƯƠNG TUYẾN CẦN THƠ – HỒNG NGỰ',
		slide: '/news1.jpg'
	},
	{
		name: 'FUTA ĐỒNG HÀNH CÙNG SHB -  X3 QUÀ TẶNG',
		slide: '/news2.jpg'
	},
	{
		name: 'PHƯƠNG TRANG – FUTA BUS LINES MỞ RỘNG MẠNG LƯỚI XE BUÝT KHÔNG TRỢ GIÁ TẠI TP. CẦN THƠ',
		slide: '/news3.jpg'
	},
	{
		name: 'CHÚC MỪNG NĂM MỚI 2024 – XUÂN GIÁP THÌN',
		slide: '/news4.png'
	},
	{
		name: 'THÁNG 12 - BUÔN MÊ NHỮNG NGÀY ĐÔNG VỀ',
		slide: '/news5.png'
	}
];
